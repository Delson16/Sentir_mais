...
public class EmotionController {
    ...
    public ResponseEntity getRecordEmotion(@PathVariable("id") String userId, @PathVariable("date") String dateStr) {
        List<EmotionRecordResponseDto> bodyResponse = emotionService.getRecordEmotion(userId, dateStr);
        return ResponseEntity.ok(bodyResponse);
    }
